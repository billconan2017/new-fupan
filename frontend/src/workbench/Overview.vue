<template>
<OperationsDashboard :day="day" :busy="busy" @open="(...args)=>emit('open',...args)" @collect="(...args)=>emit('collect',...args)"/><details class="wb-panel wb-ops-jobs"><summary>新版证据完整性 · {{ report?.ready ?? '—' }} / {{ report?.total || 7 }} 项</summary>
